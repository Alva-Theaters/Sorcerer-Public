...
import bpy
from bpy import spy
ColorSequence, SoundSequence = spy.get_sequencer_strip_types()
...
def register():
    ColorSequence.message_one_text = bpy.props.StringProperty(default="")
    ColorSequence.message_two_text = bpy.props.StringProperty(default="")
    ColorSequence.message_three_text = bpy.props.StringProperty(default="")

    spy.utils.register_class(SEQUENCER_ST_custom_strip)  # Remember to use spy.utils.register_class, not bpy.utils.register_class!
