...
import bpy
from bpy.props import StringProperty, CollectionProperty, BoolProperty, EnumProperty, IntProperty, FloatProperty, FloatVectorProperty
from bpy.types import Object, Scene, Light
from ..utils.versioning import get_sequencer_strip_types
ColorSequence, SoundSequence = get_sequencer_strip_types()
...
class CommonProperties:
    ...
    object_only = [
        ...
        ('alva_sem_channel', IntProperty(name="SEM Channel", default=0, min=0, max=9999, description=find_tooltip("sem_channel"))),
        ('alva_sem_focus_p', IntProperty(name="SEM Focus Palette", default=0, min=0, max=9999, description=find_tooltip("sem_focus_palette"))),
        ...
        ('int_speaker_number', IntProperty(name="Speaker Number", update=CommonUpdaters.speaker_number_updater, description=find_tooltip("speaker_number"), default=1)),
    ...
    parameter_toggles = [
        ...
        ('pan_tilt_is_on', BoolProperty(name="Pan/Tilt Toggle", default=True, description=find_tooltip("enable_pan_tilt"))), 
        ('color_is_on', BoolProperty(name="Color Toggle", default=True, description=find_tooltip("enable_color"))),
        ...
        ('zoom_is_on', BoolProperty(name="Zoom Toggle", default=True, description=find_tooltip("enable_zoom"))),
        ('iris_is_on', BoolProperty(name="Iris Toggle", default=True, description=find_tooltip("enable_iris"))),
...
def register():
    ...
    # Sequences
    register_properties(ColorSequence, CommonProperties.timecode_executors)
    register_properties(SoundSequence, CommonProperties.timecode_executors)
...
def unregister():
    ...
    # Sequences
    register_properties(ColorSequence, CommonProperties.timecode_executors, register=False)
    register_properties(SoundSequence, CommonProperties.timecode_executors, register=False)
